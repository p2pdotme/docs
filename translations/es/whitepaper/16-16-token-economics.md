...
sidebar_position: 16
title: "16. Economía del Token"
slug: token-economics
---

El token del protocolo es un **token de propiedad**. Las partes más importantes del protocolo —propiedad intelectual, fondos de tesorería y la capacidad de acuñar nuevos tokens— están controladas por los holders de tokens a través de [gobernanza basada en futarchy](https://en.wikipedia.org/wiki/Futarchy), y no por ningún equipo, fundación o entidad individual. Esto es propiedad real e unruggable de una infraestructura generadora de ingresos.

En el aspecto de propiedad, las decisiones que afectan el suministro del token deben pasar por un mecanismo de gobernanza de mercado de decisiones, donde los participantes apuestan capital real sobre si una propuesta aumentará o disminuirá el valor del token. Las propuestas que el mercado predice que dañarán el valor se rechazan automáticamente. Esto reemplaza la votación subjetiva con responsabilidad impulsada por el mercado.
